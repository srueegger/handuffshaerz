...
function huh_startup_scripts() {
	...
	if (WP_DEBUG) {
		wp_enqueue_style( 'huh-style', DEV_CSS . '/theme.css', array('huh-google-font'), '2.5' );
		wp_register_script( 'huh-script', DEV_JS ."/theme.js", array('jquery', 'huh-google-maps'), '1.6', true );
	} else {
		wp_enqueue_style( 'huh-style', DIST_CSS . '/theme.min.css', array('huh-google-font'), '2.5' );
		wp_register_script( 'huh-script', DIST_JS ."/theme.min.js", array('jquery', 'huh-google-maps'), '1.6', true );
	}
	$global_vars = array(
