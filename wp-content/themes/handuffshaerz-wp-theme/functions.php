...
add_image_size( 'fullwidth-xl-2x', 3840, 2160, true );
add_image_size( 'fullwidth-lg-2x', 1984, 1322, true );
add_image_size( 'fullwidth-md-2x', 1536, 1024, true );
add_image_size( 'fullwidth-sm-2x', 1152, 768, true );
add_image_size( 'fullwidth-xs-2x', 800, 534, true );
...
add_image_size( 'teamfoto-xl-2x', 700, 882, true );
add_image_size( 'teamfoto-lg-2x', 640, 832, true );
add_image_size( 'teamfoto-md-2x', 1020, 1286, true );
add_image_size( 'teamfoto-sm-2x', 990, 1374, true );
add_image_size( 'teamfoto-xs-2x', 580, 730, true );
